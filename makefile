...
tests: ${HEADERS} linearRangeProperties.o AUTO_TEST/linearRangeTests.o
	@echo LD tests
	${GPP} ${CXXOPTS} -o tests AUTO_TEST/linearRangeTests.o linearRangeProperties.o `llvm-config --cppflags --ldflags --libs core mcjit native` ${LIBS}
